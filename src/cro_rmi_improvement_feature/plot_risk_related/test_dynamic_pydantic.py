...
if __name__ == "__main__":
    ...
    fields_data_1 = {
        ...
        "age": (
            int,
            pydantic.Field(
                ge=0, description="The age of the person, must be non-negative"
            ),
        ),
        "email": (
            str,
        ...
        try:
            ...
            if model_name == "Product":
                ...
                try:
                    ...
                    print(
                        f"  {model_name} instance: {product.model_dump_json(indent=2)}"
                    )
                except pydantic.ValidationError as e:
                ...
                try:
                    ...
                    print(
                        f"  {model_name} instance: {reading.model_dump_json(indent=2)}"
                    )
                except pydantic.ValidationError as e:
